<body class="text-center">
  <form class="form-signin" action="<?= base_url('') ?>" method="POST">
    ...
    <h1 class="h3 mb-3 font-weight-normal">Hasil Persegi</h1>
    <hr>
    <div class="form-group row">
      <label class="col-sm-4 col-form-label text-left">Panjang</label>
      <div class="col-sm-8">
        <input type="text" step="any" id="name" class="form-control" value="<?= $data['panjang'] ?> cm" readonly>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-sm-4 col-form-label text-left">Lebar</label>
      <div class="col-sm-8">
        <input type="text" step="any" id="name" class="form-control" value="<?= $data['lebar'] ?> cm" readonly>
      </div>
    </div>
    <div class="form-group row">
